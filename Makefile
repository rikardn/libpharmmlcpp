...
CExternalDataset.o: src/consolidators/ExternalDataset.cpp src/consolidators/ExternalDataset.h
	$(CC) -c src/consolidators/ExternalDataset.cpp -oCExternalDataset.o $(CFLAGS)
