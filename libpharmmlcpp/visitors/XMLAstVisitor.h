...
#ifndef PHARMMLCPP_XMLASTVISITOR_H_
#define PHARMMLCPP_XMLASTVISITOR_H_
...
namespace pharmmlcpp
{
    class XMLAstVisitor : public AstNodeVisitor
    {
        public:
            ...
            void visit(ScalarId *node) override;
            void visit(ScalarNA *node) override;
            void visit(ScalarNaN *node) override;
            void visit(ScalarPlusInf *node) override;
            void visit(ScalarMinusInf *node) override;
            void visit(ScalarBLQ *node) override;
            void visit(ScalarALQ *node) override;
